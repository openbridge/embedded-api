...
|---|---|---|
| `id` | Ad account ID (numeric string, `act_` prefix stripped) | Use as `account_id` in subscription [`product_parameters`](./subscriptions-api.md) |
...
| Field | Description | Use in subscription |
|---|---|---|
| `id` | Facebook Page ID | Use as `page_id` in subscription [`product_parameters`](./subscriptions-api.md) |
