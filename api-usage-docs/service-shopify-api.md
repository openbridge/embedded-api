...
| `shop.myshopify_domain` | Permanent `.myshopify.com` subdomain | Use as `shop` identifier in subscription [`product_parameters`](./subscriptions-api.md) |
...
| `shop.name` | Store display name | Display in UI |
| `shop.myshopifyDomain` | Permanent `.myshopify.com` subdomain | Use as `shop` identifier in subscription [`product_parameters`](./subscriptions-api.md) |
