...
run_test "Stages List" "stages_cmd list --product 70" 0  # Explicitly expect success

# Error cases - expect status 255 for error_exit calls
run_test "Missing Product ID" "stages_cmd list" 255
run_test "Invalid Subcommand" "stages_cmd invalid_subcommand" 255
