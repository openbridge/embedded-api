...
run_test "Missing ID" "identity_cmd get" 255
run_test "Invalid Date Format" "identity_cmd list --invalidated-before 'invalid-date'" 255
run_test "Invalid Range Format" "identity_cmd list --range invalid" 255
run_test "Unknown Option" "identity_cmd list --unknown-option value" 255
