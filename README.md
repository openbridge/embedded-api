...
- [APIs](#apis)
  ...
  - [Service API](#service-api)
    ...
    - [Healthchecks](#healthchecks-query)
...
### Produts and related identity types

#### Amazon Advertising Products

> | id | Name | Remote Identity Type Id
> |-|-|-|
> | `40` | `Amazon	Advertising (SB/SD)` | `14` |
> | `70` | `Amazon	Advertising (SP)` | `14` |
> | `75` | `Amazon	Advertising Brand Metrics` | `14` |
> | `50` | `Amazon	Attribution` | `14` |
> | `54` | `Amazon	DSP` | `14` |


#### Amazon Seller Central Products

> | id | Name | Remote Identity Type Id
> |-|-|-|
> | `53` | `Amazon	Orders API` | `17` |
> | `55` | `Amazon	Finance Real-Time` | `17` |
> | `56` | `Amazon	Inbound Fulfillment` | `17` |
> | `57` | `Amazon	Settlement Reports` | `17` |
> | `58` | `Amazon	Fulfillment` | `17` |
> | `60` | `Amazon	Inventory` | `17` |
> | `61` | `Amazon	Sales Reports` | `17` |
> | `62` | `Amazon	Fees` | `17` |
> | `64` | `Amazon	Sales & Traffic` | `17` |
> | `65` | `Amazon	Seller Brand Analytics Reports` | `17` |

			
#### Amazon Vendor Central Products

> | id | Name | Remote Identity Type Id
> |-|-|-|
> | `66` | `Amazon	Vendor Retail Analytics` | `18` |
> | `67` | `Amazon	Vendor Retail Procurement` | `18` |
> | `69` | `Amazon	Vendor Brand Analytics Reports` | `18` |
> | `72` | `Amazon	Vendor Real-time Reports` | `18` |
...
> | id | Name | Remote Identity Type Id
> |-|-|-|
> | `3` | `Google	Analytics 360` | `1` |
> | `4` | `Google	Campaign Manager` | `1` |
> | `7` | `Google	Search Ads 360` | `1` |
> | `63` | `Google Ads` | `8` |
...
> | id | Name | Remote Identity Type Id
> |-|-|-|
> | `17` | `Youtube	Channel Insights` | `1` |
> | `18` | `Youtube	Competitor Channels` | `1` |
> | `26` | `Youtube	Video Insights` | `1` |
> | `15` | `Youtube	Competitor Video` | `1` |
...
> | id | Name | Remote Identity Type Id
> |-|-|-|
> | `11` | `Facebook	Marketing` | `2` |
> | `2` | `Facebook	Page Insights` | `2` |
> | `34` | `Instagram	Insights` | `2` |
> | `38` | `Instagram	Stories` | `2` |


### Produt subscription_product_meta payloads

#### Amazon Seller & Vendor Central Payload
Amazon Seller Central and Vendor Central subscription payloads are the same with the exception of the product ids used in the payloads
...
```json
  {
    "data": {
      ...
      "attributes": {
        ...
        "price": 0,
        "auto_renew": 1,
        "date_start": "2023-01-01 00:00:01",
        "date_end": "2023-01-01 00:00:01",
        "invalid_subscription": 0,
        "rabbit_payload_successful": 0,
        "stripe_subscription_id": "",
        "storage_group": ZZZZ,
...
The 4 Amazon Advertising products use 3 different payloads with only products 70 and 75 sharing the same payload.
